...
public class AreaAdministrativaCriarCuriosidade extends javax.swing.JFrame {
    ...
    public AreaAdministrativaCriarCuriosidade() {
        initComponents();
        ...
        try {
            ...
            for(int i=0;i<cartas.size();i++){
                campo_elemento.addItem(cartas.get(i).getNumero()+" - "+cartas.get(i).getElemento());
            }
    ...
    private void initComponents() {
        ...
        texto_criarCuriosidade = new javax.swing.JLabel();
        ...
        texto_criarCuriosidade.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        texto_criarCuriosidade.setForeground(new java.awt.Color(0, 0, 0));
        texto_criarCuriosidade.setText("Criar Curiosidade");
        ...
        texto_salvar.setText("Salvar Curiosidade");
    ...
    private void botao_salvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botao_salvarMouseClicked
        ...
        try {
            ...
            if ((campo_curiosidade.getText().matches("^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÍÏÓÔÕÖÚÇÑ'\\s!.,:@#$%&*\\(\\)?'[0-9]]+$")&&(!"".equals(campo_curiosidade.getText())))){
                ...
                arquivos.salvarNovaCuriosidades(Integer.valueOf(dados_elemento[0]),dados_elemento[1],campo_curiosidade.getText());
    ...
    private javax.swing.JLabel texto_criarCuriosidade;
